...
typedef OnUnhandled = Function(
    OnUnhandledReason reason, BackdoorPaymentModel? backdoorPaymentModel);
...
typedef OnLimitedLaunch = Function(
    BackdoorPaymentModel backdoorPaymentModel, int currentCount);
...
typedef OnTrial = Function(BackdoorPaymentModel backdoorPaymentModel,
    DateTime expiryDate, DateTime? warningDate);
...
typedef OnTrialWarning = Function(BackdoorPaymentModel backdoorPaymentModel,
    DateTime expiryDate, DateTime warningDate);
...
typedef OnTrialEnded = Function(
    BackdoorPaymentModel backdoorPaymentModel, DateTime expiryDate);
